...
ScrollReveal().reveal('.headlined', { 
    duration:2500,
});

ScrollReveal().reveal('.headlinedsf', { 
    duration:1500,
});
...
ScrollReveal().reveal('.punchline_cs', { 
    delay: 250,
    origin: 'left',
    distance:'60px',
});

ScrollReveal().reveal('.punchline_csas', { 
    delay: 1800,
    origin: 'left',
    distance:'60px',
});
...
ScrollReveal().reveal('.punchline_d', { 
    delay: 250,
    origin: 'right',
    distance:'60px',
});

ScrollReveal().reveal('.punchline_e', { 
    delay: 350,
    origin: 'right',
    distance:'60px',
});
